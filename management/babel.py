...
class Babel:
    ...
    def _get_locale(self, argv: list) -> None:
        ...
        try:
            ...
            if self.method not in self.methods_with_required_locale:
    ...
    def _extract(self, is_exit: bool = True) -> None:
        """(приватный) Генерация .po файла для выбранной локали на основе строк в коде приложения
    ...
    def init(self) -> None:
        ...
        sys.argv = [
            '',
            'init',
            f'--domain={LOCALEDOMAIN}',
            f'--output-dir={LOCALEDIR}',
            f'--input-file={self.default_locale_file}',
    ...
    def reload(self) -> None:
        """Извлечение .po файл для локали по-умолчанию изменений в коде
            и обновление .po файла выбранной локали
